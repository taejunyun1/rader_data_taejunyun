...
describe("RadarView", () => {
  it("shows the dashboard reading order and Korean navigation actions", async () => {
    ...
    expect(screen.getByRole("heading", { name: "이번 주 새로 떠오른 키워드" })).toBeInTheDocument();
